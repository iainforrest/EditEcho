...
import com.editecho.network.dto.MessageRequestBody
import com.editecho.network.dto.RunRequestBody
import com.editecho.network.dto.ThreadResponse
import com.editecho.network.dto.RunResponse
import com.editecho.network.dto.StreamEvent
    ...
    suspend fun startRunStreaming(
        ...
        try {
            ...
            val sseRequest = Request.Builder()
                ...
                .addHeader("Authorization", "Bearer ${com.editecho.BuildConfig.OPENAI_API_KEY}")
